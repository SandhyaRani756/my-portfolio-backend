...
export interface ApiCareerObjectiveCareerObjective
  extends Struct.CollectionTypeSchema {
  collectionName: 'career_objectives';
  info: {
    displayName: 'Career Objective';
    pluralName: 'career-objectives';
    singularName: 'career-objective';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::career-objective.career-objective'
    > &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::career-objective.career-objective': ApiCareerObjectiveCareerObjective;
